...
class Player(Bot):
    ...
    def __init__(self):
        ...
        self.five_style_dict={"soft":0, "mediumsoft":0, "medium":0, "mediumhard":0, "hard":0}
		self.five_style_list=["soft","mediumsoft","medium","mediumhard","hard"]
...
`
        ...
        while round_num<200:
			...
			style=self.five_style_list[style_integer]
			if style=="soft":
				starting_amount=45
	...
	self.three_style_list.append(max(self.five_style_dict, key=lambda key: self.five_style_dict[key]))
	self.five_style_dict.pop(max(self.five_style_dict, key=lambda key: self.five_style_dict[key]))
	self.three_style_list.append(max(self.five_style_dict, key=lambda key: self.five_style_dict[key]))
	self.five_style_dict.pop(max(self.five_style_dict, key=lambda key: self.five_style_dict[key]))
	self.three_style_list.append(max(self.five_style_dict, key=lambda key: self.five_style_dict[key]))
	self.five_style_dict.pop(max(self.five_style_dict, key=lambda key: self.five_style_dict[key]))
	for key in self.three_style_list:
		self.three_style_dict[key]=0
	while round number<400:
		style_integer=random.randint(0,3)
		style=self.three_style_list[style_integer]
		if style=="soft":
			starting_amount=45
		elif style=="mediumsoft":
			starting_amount=40
		...
		for key in self.three_style_dict:
				if key==style:
					three_style_dict[key]+=my_delta
	style=max(three_style_dict, key=lambda key: self.three_style_dict[key])
	if style=="soft":
			starting_amount=45
		elif style=="mediumsoft":
			starting_amount=40
